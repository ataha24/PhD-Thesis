...
\begin{center}
  ...
  \textbf{together} we can do so much."}
...
\addlinespace[1ex]
\multicolumn{3}{l}{\textbf{Open Science and Reproducibility}} \\
GitHub & & GitHub (Collaborative Code Hosting Platform) \\
Zenodo & & Zenodo (Open Access Research Repository) \\
...
AutoAFIDs & & Automated AFID Detection Model \\
\end{longtable}
