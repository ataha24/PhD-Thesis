...
\textbf{Generalizability to Other Brain Landmarks:} To assess the broader applicability of our framework, we extended the localization approach to nine additional midbrain landmarks (see Figure~\ref{fig:ch4_Figure_bench}c). The model maintained high accuracy across all these structures, achieving a median ED of 1.27~$\pm$~0.96~mm (IQR: 0.73–2.00) which is within what we observed at the STN.
